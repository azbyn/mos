...
if (isRandomAccessRange!Range && hasLength!Range && hasSlicing!Range && hasAssignableElements!Range)
{
        ...
        )))
    {
        ...
        for (;;)
        {
            ...
            version(unittest)
            {
                // this used to import stdd.algorithm.all, but we want to save
...
@safe unittest
{
    import stdd.random : Random = Xorshift, uniform;
...
All of its inputs are assumed to be sorted. This can mean that inputs are
   ...
   stdd,algorithm,sorting), or $(REF assumeSorted, std,range) to merge ranges
...
@safe unittest
{
    ...
    import stdd.algorithm.iteration, std.algorithm.mutation, std.random;
    Random rng;
...
if (isRandomAccessRange!R && hasLength!R && hasSwappableElements!R)
{
    ...
    static trustedMalloc(size_t len) @trusted
    {
        ...
        import core.stddc.stdlib : malloc;
        bool overflow;
...
@system unittest
{
    import stdd.random : Random = Xorshift, uniform, randomShuffle;
    import stdd.typecons : Yes;
