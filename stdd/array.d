...
Returns: A $(REF_ALTTEXT forward range, isForwardRange, stdd,range,primitives)
...
The `range` must be a $(REF_ALTTEXT forward range, isForwardRange, stdd,range,primitives).
...
if (isDynamicArray!A)
{
     ...
     *     fmt = A $(REF FormatSpec, stdd, format) which controls how the array
     *     is formatted.
     * Returns:
