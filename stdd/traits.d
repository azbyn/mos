...
Returns:
    $(REF AliasSeq,stdd,meta) of all interfaces directly or
...
Returns:
    An $(REF AliasSeq,stdd,meta) with all possible target types of an implicit
    conversion `T`.
    ...
    `Object`, the an empty $(REF AliasSeq,stdd,meta) is returned.
...
`stdd.range.ElementType!Range` in the case of narrow strings, or if T
...
@safe unittest
{
    ...
    static assert(mangledName!mangledName == "3stdd6traits11mangledName");
    static assert(mangledName!freeFunc == "_D3stdd6traits8freeFuncFAyaZv");
    int x;
