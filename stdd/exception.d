...
class ErrnoException : Exception
{
    ...
    private uint _errno;
    /// Constructor which takes an error message. The current global $(REF errno, core,stddc,errno) value is used as error code.
...
bound (see $(REF hasSlicing, stdd,range,primitives)); `handle` deals with
