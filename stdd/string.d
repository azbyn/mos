...
/++
    ...
    $(REF paraSep, stdd,uni), `U+0085` (NEL), `'\v'`  and `'\f'`
 ...
 *  Split an array or slicable range of characters into a range of lines
    using `'\r'`, `'\n'`, `'\v'`, `'\f'`, `"\r\n"`,
    $(REF lineSep, stdd,uni), $(REF paraSep, stdd,uni) and `'\u0085'` (NEL)
...
/++
    ...
    `"\r\n"`, `'\f'`, `'\v'`, $(REF lineSep, stdd,uni), $(REF paraSep, stdd,uni), or $(REF nelSep, stdd,uni)
