 ...
 * Mathematical special functions are available in `stdd.mathspecial`.
 *
...
import stdd.traits; // CommonType, isFloatingPoint, isIntegral, isSigned, isUnsigned, Largest, Unqual
...
version(unittest) private
{
    ...
    {
        import core.stdc.stddio : sprintf;
...
import stdd.meta : AliasSeq;
deprecated("Please use stdd.complex")
 ...
 */
deprecated("Please use stdd.complex.conj")
 ...
 */
deprecated("Use stdd.complex.sin")
 ...
 */
deprecated("Use stdd.complex.cos")
...
{
    assert(equalsDigit(tan(PI / 3), stdd.math.sqrt(3.0), useDigits));
}
...
@safe unittest
{
    ...
    assert(acos(0.5).approxEqual(stdd.math.PI / 3));
    assert(acos(PI).isNaN);
}

@safe @nogc nothrow unittest
{
    assert(equalsDigit(acos(0.5), stdd.math.PI / 3, useDigits));
}
...
@safe @nogc nothrow unittest
{
    assert(equalsDigit(atan(stdd.math.sqrt(3.0)), PI / 3, useDigits));
}
...
@safe @nogc nothrow unittest
{
    assert(equalsDigit(atan2(1.0L, stdd.math.sqrt(3.0L)), PI / 6, useDigits));
}
...
deprecated("Use stdd.complex.sqrt")
 ...
 */
deprecated("Use stdd.complex.expi")
...
private:
    ...
    static void setControlState(ControlState newState) @trusted pure
    {
        version (InlineAsm_X86_Any)
        {
...
{
    import stdd.range.primitives : empty, front, isInputRange, popFront;
