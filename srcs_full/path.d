...
/** This module is used to manipulate _path strings.
    ...
    To differentiate between these cases, use $(REF isDir, stdd,file) and
    $(REF exists, stdd,file).
...
$(TR $(TD Other) $(TD
    ...
    Source:
        $(PHOBOSSRC stdd/_path.d)
*/
module stdd.path;


// FIXME
import stdd.file; //: getcwd;
...
if (Ranges.length >= 2 &&
    stdd.meta.anySatisfy!(isConvertibleToString, Ranges))
{
    ...
    !isConvertibleToString!R2))
{
    ...
    import stdd.range : repeat, chain, choose;
    import stdd.utf : byCodeUnit, byChar;
...
@safe unittest
{
    import stdd.array, stdd.utf : bCU=byCodeUnit;
    version (Posix)
    {
...
in
{
    ...
    import stdd.algorithm.searching : balancedParens;
...
/** Checks whether $(D path) is a valid _path.
    ...
    or directory; use $(REF exists, stdd,file) for this purpose.)
...
@system unittest
{
    version (Posix)
    {
        import stdd.process : executeShell, environment;
