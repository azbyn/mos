...
Source: $(PHOBOSSRC stdd/experimental/allocator/_showcase.d)
*/
...
auto mmapRegionList(size_t bytesPerRegion)
{
    static struct Factory
    {
        ...
        import stdd.experimental.allocator.building_blocks.region
            : Region;
        import stdd.experimental.allocator.mmap_allocator
            : MmapAllocator;
        this(size_t n)
        {
            bytesPerRegion = n;
