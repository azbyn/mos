...
stdd,experimental,_allocator,typed) module. It allows an interested user to e.g.
...
stdd,experimental,_allocator,showcase) which defines a collection of frequently-
used preassembled allocator objects. The implementation and documentation entry
point is $(MREF stdd,experimental,_allocator,building_blocks). By design, the
...
($(MREF stdd,experimental,_allocator,gc_allocator)), the C `malloc` family
($(MREF stdd,experimental,_allocator,mallocator)), and the OS ($(MREF
stdd,experimental,_allocator,mmap_allocator)). Most custom allocators would
ultimately obtain memory from one of these core allocators.)
)

$(H2 Idiomatic Use of $(D stdd.experimental._allocator))

As of this time, $(D stdd.experimental._allocator) is not integrated with D's
built-in operators that allocate memory, such as `new`, array literals, or
array concatenation operators. That means $(D stdd.experimental._allocator) is
...
stdd,experimental,_allocator,building_blocks,free_list) would be recommended.
To install one in `main`, the application would use:

----
void main()
{
    import stdd.experimental.allocator.building_blocks.free_list
        : FreeList;
...
Source: $(PHOBOSSRC stdd/experimental/_allocator)

*/

module stdd.experimental.allocator;

public import stdd.experimental.allocator.common,
    stdd.experimental.allocator.typed;

// Example in the synopsis above
@system unittest
{
    import stdd.algorithm.comparison : min, max;
    import stdd.experimental.allocator.building_blocks.allocator_list
        : AllocatorList;
    import stdd.experimental.allocator.building_blocks.bitmapped_block
        : BitmappedBlock;
    import stdd.experimental.allocator.building_blocks.bucketizer : Bucketizer;
    import stdd.experimental.allocator.building_blocks.free_list : FreeList;
    import stdd.experimental.allocator.building_blocks.segregator : Segregator;
    import stdd.experimental.allocator.gc_allocator : GCAllocator;
...
in $(MREF stdd,experimental,allocator,building_blocks),
...
`stdd.experimental.allocator.building_blocks`), then adapt the composed
...
@system unittest
{
    import stdd.experimental.allocator.building_blocks.region : Region;
...
{
    import stdd.conv;
    import stdd.experimental.allocator.mallocator;
    import stdd.experimental.allocator.building_blocks.stats_collector;
...
multiple calls. Instead, compose allocators using the static interface defined
in $(A std_experimental_allocator_building_blocks.html,
`stdd.experimental.allocator.building_blocks`), then adapt the composed allocator
...
@system unittest
{
    ...
    import stdd.experimental.allocator.building_blocks.free_list : SharedFreeList;
    import stdd.experimental.allocator.mallocator : Mallocator;
...
auto make(T, Allocator, A...)(auto ref Allocator alloc, auto ref A args)
{
    ...
    import stdd.conv : emplace, emplaceRef;
...
@safe unittest
{
    import stdd.exception : assertThrown, enforce;
...
if (T.sizeof == 1)
{
    ...
    import stdd.traits : CopyConstness;
...
T[] makeArray(T, Allocator)(auto ref Allocator alloc, size_t length, T init)
{
    ...
    import stdd.traits : hasElaborateCopyConstructor;
    ...
    size_t delta, auto ref T init)
{
    ...
    import stdd.algorithm.mutation : uninitializedFill;
...
@system unittest
{
    ...
    {
        import stdd.experimental.allocator.common : platformAlignment;
        import stdd.experimental.allocator.mallocator : Mallocator;
...
shared storage.)
$(LI If $(D A) has state, the result will $(REF move, stdd,algorithm,mutation)
...
@system unittest
{
    ...
    import stdd.experimental.allocator.building_blocks.region : InSituRegion;
...
$(REF move, stdd,algorithm,mutation) the supplied allocator $(D A a) within.
...
{
    import stdd.experimental.allocator.building_blocks.affix_allocator : AffixAllocator;
...
{
    import stdd.experimental.allocator.mallocator : Mallocator;
    import stdd.random : randomCover;
...
unittest
{
    import stdd.experimental.allocator.building_blocks.null_allocator : NullAllocator;
    import stdd.experimental.allocator.building_blocks.allocator_list : AllocatorList;
    import stdd.experimental.allocator.building_blocks.bitmapped_block : BitmappedBlock;
    import stdd.experimental.allocator.building_blocks.segregator : Segregator;
    import stdd.experimental.allocator.building_blocks.bucketizer : Bucketizer;
    import stdd.experimental.allocator.building_blocks.free_list : FreeList;
    import stdd.experimental.allocator.gc_allocator : GCAllocator;
    ...
    import stdd.stdio;
    import stdd.conv : to;
    import stdd.datetime.stopwatch;
    import stdd.algorithm.iteration : map;
...
unittest
{
    import stdd.experimental.allocator.building_blocks.free_list : FreeList;
    import stdd.experimental.allocator.building_blocks.region : InSituRegion;
    import stdd.experimental.allocator.building_blocks.fallback_allocator : FallbackAllocator;
    import stdd.experimental.allocator.gc_allocator : GCAllocator;
    import stdd.experimental.allocator.mallocator : Mallocator;
