...
/**
This module implements experimental additions/modifications to $(MREF stdd, _typecons).

Use this module to test out new functionality for $(REF wrap, stdd, _typecons)
which allows for a struct to be wrapped against an interface; the
implementation in $(MREF stdd, _typecons) only allows for classes to use the wrap
functionality.

Source:    $(PHOBOSSRC stdd/experimental/_typecons.d)
...
Authors:   $(HTTP erdani.org, Andrei Alexandrescu),
           ...
           Kenji Hara
 */
module stdd.experimental.typecons;

import stdd.meta; // : AliasSeq, allSatisfy;
import stdd.traits;

import stdd.typecons : Tuple, tuple, Bind, DerivedFunctionType, GetOverloadedMethods;
...
{
    import stdd.meta : ApplyLeft, staticMap;
...
version(StdDdoc)
{
     ...
     *
     * Throws: $(REF ConvException, stdd, conv) when attempting to extract a
