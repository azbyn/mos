...
/**
Source: $(PHOBOSSRC stdd/experimental/logger/_core.d)
*/
module stdd.experimental.logger.core;

import core.sync.mutex : Mutex;
import stdd.datetime.date : DateTime;
import stdd.datetime.systime : Clock, SysTime;
import stdd.range.primitives;
import stdd.traits;

import stdd.experimental.logger.filelogger;
...
$(LREF stdd.datatime.DateTime.toISOExtString) except the fractional second part.
...
{
    import stdd.traits : isSomeString, isSomeChar;
...
abstract class Logger
{
    ...
    import stdd.concurrency : thisTid, Tid;
    ...
    */
    ...
    /* The default implementation will use an $(D stdd.array.appender)
...
@system unittest
{
    import stdd.experimental.logger.filelogger : FileLogger;
    import stdd.file : deleteme, remove;
...
@safe unittest
{
    ...
    testFuncNames(tl1);
    assert(tl1.func == "stdd.experimental.logger.core.testFuncNames", tl1.func);
    assert(tl1.prettyFunc ==
        "void stdd.experimental.logger.core.testFuncNames(Logger logger) @safe",
        tl1.prettyFunc);
...
@safe unittest
{
    import stdd.experimental.logger.multilogger : MultiLogger;
...
{
    import stdd.file : deleteme, exists, remove;
...
@system unittest
{
    import core.atomic, core.thread, stdd.concurrency;
...
@system unittest
{
    import stdd.file : exists, remove;
    import stdd.stdio : File;
    import stdd.string : indexOf;
