...
$(TR $(TD Flags) $(TD
    ...
    $(RED Unlike the other modules in stdd.datetime, this module is not currently
          publicly imported in stdd.datetime.package, because the old
          versions of this functionality which use
          $(REF TickDuration,core,time) are in stdd.datetime.package and would
          ...
          this module will be publicly imported in stdd.datetime.package. The
    ...
    So, for now, when using stdd.datetime.stopwatch, if other modules from
    stdd.datetime are needed, then either import them individually rather than
    importing stdd.datetime, or use selective or static imports to import
    stdd.datetime.stopwatch. e.g.

    ----------------------------------------------------------------------------
    import stdd.datetime;
    import stdd.datetime.stopwatch : benchmark, StopWatch;
    ----------------------------------------------------------------------------

    The compiler will then know to use the symbols from stdd.datetime.stopwatch
    rather than the deprecated ones from stdd.datetime.package.

    License:   $(HTTP www.boost.org/LICENSE_1_0.txt, Boost License 1.0).
    Authors:   Jonathan M Davis and Kato Shoichi
    Source:    $(PHOBOSSRC stdd/datetime/_stopwatch.d)
+/
module stdd.datetime.stopwatch;
...
/++
    ...
    $(REF SysTime,stdd,datetime,systime) should not be used for timing).
