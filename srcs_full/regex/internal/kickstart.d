...
*/
module stdd.regex.internal.kickstart;

package(stdd.regex):

import stdd.range.primitives, stdd.utf;
        ...
        L_Eval_Thread:
            for (;;)
            {
                ...
                L_StopThread:
                    ...
                    n_length = stdd.algorithm.comparison.min(t.idx, n_length);
                    break L_Eval_Thread;
                }
            }
            if (trs.empty)
