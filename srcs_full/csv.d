 ...
 *
 * When performing type conversions, $(REF ConvException, stdd,conv) is stored in
 * the $(D next) field.
 */
 ...
 *        $(REF isInputRange, stdd,range,primitives). When $(D Contents) is a
...
{
    import stdd.array : appender;
    import stdd.range.primitives : popFront;
