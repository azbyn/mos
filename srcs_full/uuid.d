...
public struct UUID
{
    ...
    public:
         ...
         *
         * Note: Do not confuse this with $(REF _Variant, stdd,_variant).
         */
        enum Variant
        {
         ...
         * $(D stdd.uuid), but only version 3, 4 and 5 UUIDs can be generated.
         */
        enum Version
        {
            ///Unknown version
         ...
         *
         * Note: Do not confuse this with $(REF _Variant, stdd,_variant).
         * The type of this property is $(MYREF3 stdd.uuid.UUID.Variant, _Variant).
         *
         * See_Also:
       ...
       @safe pure nothrow @nogc UUID opAssign(in UUID s)
        ...
        {
            // @system due to cast
            import stdd.encoding : Char = AsciiChar;
 ...
 * and byte arrays used by $(D stdd.uuid) is compatible with Boost's implementation.
 * $(D stdd.uuid) guarantees that the same input to this function will generate
 ...
 * See_Also: $(REF isUniformRNG, stdd,random)
 */
...
{
    import stdd.random : isUniformRNG;
...
@safe unittest
{
    import stdd.random : Xorshift192, unpredictableSeed;
...
@safe unittest
{
    import stdd.random : rndGen, Mt19937;
    ...
    && is(Unqual!(ElementType!Range) == dchar))
{
    ...
    import stdd.conv : ConvException, parse;
