 ...
 *            Copyright (C) 1994 Stephen L. Moshier (moshier@world.stdd.com).
 * License:   $(HTTP www.boost.org/LICENSE_1_0.txt, Boost License 1.0).
 * Authors:   Stephen L. Moshier (original C code). Conversion to D by Don Clugston
 * Source:    $(PHOBOSSRC stdd/_mathspecial.d)
 */
module stdd.mathspecial;
public import stdd.math;
private import stdd.internal.math.gammafunction;
private import stdd.internal.math.errorfunction;
...
real gamma(real x)
{
    return stdd.internal.math.gammafunction.gamma(x);
}
...
{
    return stdd.internal.math.gammafunction.logGamma(x);
}
...
real digamma(real x)
{
    return stdd.internal.math.gammafunction.digamma(x);
}
...
{
    return stdd.internal.math.gammafunction.logmdigamma(x);
}
...
{
    return stdd.internal.math.gammafunction.logmdigammaInverse(x);
}
...
{
    return stdd.internal.math.gammafunction.betaIncomplete(a, b, x);
}
...
{
    return stdd.internal.math.gammafunction.betaIncompleteInv(a, b, y);
}
...
body {
    return stdd.internal.math.gammafunction.gammaIncomplete(a, x);
}
...
body {
    return stdd.internal.math.gammafunction.gammaIncompleteCompl(a, x);
}
...
body {
    return stdd.internal.math.gammafunction.gammaIncompleteComplInv(a, p);
}
...
real erf(real x)
{
    return stdd.internal.math.errorfunction.erf(x);
}
...
real erfc(real x)
{
    return stdd.internal.math.errorfunction.erfc(x);
}
...
{
    return stdd.internal.math.errorfunction.normalDistributionImpl(x);
}
...
body
{
    return stdd.internal.math.errorfunction.normalDistributionInvImpl(p);
}
