...
import stdd.stdiobase;
import stdd.traits; // isSomeChar, isSomeString, Unqual
 ...
 */
    void sync() @trusted
    {
        ...
        {
            import core.sys.posix.unistdd : fsync;
            import stdd.exception : errnoEnforce;
 ...
 */
    ...
    @system unittest
    {
        ...
        static void runForked(void delegate() code)
        {
            ...
            import core.sys.posix.unistdd : fork;
            int child, status;
            if ((child = fork()) == 0)
            {
                code();
...
/** ditto */
     ...
     * $(REF formattedRead, stdd,_format).
     */
...
version(linux)
{
    File openNetwork(string host, ushort port)
    {
        ...
        static import core.sys.posix.unistdd;
        import core.stdc.string : memcpy;
        ...
        scope(failure)
        {
            ...
            core.sys.posix.unistdd.close(s);
        }
