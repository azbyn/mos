 ...
 * Source: $(PHOBOSSRC stdd/_bigint.d)
 */
...
private import stdd.internal.math.biguintcore;
private import stdd.format : FormatSpec, FormatException;
private import stdd.traits;
private import stdd.range.primitives;
...
public:
    ...
    @system unittest
    {
        // system because of the dummy ranges eventually call stdd.array!string
    ...
    /**
        ...
        Throws: $(REF ConvOverflowException, stdd,conv) if the number exceeds
    ...
    T opCast(T:ulong)() /*pure*/ const
    {
        ...
        import stdd.conv : ConvOverflowException;
    ...
    @system unittest
    {
        import stdd.conv : to, ConvOverflowException;
        import stdd.exception : assertThrown;
