...
struct JSONValue
{
    import stdd.exception : enforceEx, enforce;
    ...
    */
    ...
    private void assign(T)(T arg) @safe
    {
        ...
        {
            type_tag = JSON_TYPE.STRING;
            // FIXME: stdd.array.array(Range) is not deduced as 'pure'
            () @trusted {
...
if (isInputRange!T)
{
    import stdd.ascii : isWhite, isDigit, isHexDigit, toUpper, toLower;
...
/**
Parses a serialized string and returns a tree of JSON values.
Throws: $(REF JSONException, stdd,json) if the depth exceeds the max depth.
Params:
    json = json-formatted string to parse
    options = enable decoding string representations of NaN/Inf as float values
*/
