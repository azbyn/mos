...
import stdd.digest.crc, std.file, std.stdio, std.zip;
...
final class ArchiveMember
{
     ...
     * $(REF getAttributes, stdd,file) or $(REF DirEntry.attributes, std,file), for this archive member.
     */
...
{
    import stdd.datetime, std.file, std.format, std.path, std.process, std.stdio;
