...
Example:
----
import stdd.algorithm, stdd.stdio, stdd.string;
...
Example:
----
import stdd.algorithm, stdd.array, stdd.stdio;
...
import stdd.algorithm, stdd.stdio;
void main()
{
...
---
import stdd.algorithm, stdd.range, stdd.stdio;
...
/**
 * Reads formatted data from $(D stdin) using $(REF formattedRead, stdd,_format).
 * Params:
 * format = The $(REF_ALTTEXT format string, formattedWrite, stdd, _format).
 * When passed as a compile-time argument, the string will be statically checked
 * against the argument types passed.
