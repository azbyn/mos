...
The $(MREF stdd, _range, primitives) submodule
...
The $(MREF stdd, _range, interfaces) submodule
...
Source: $(PHOBOSSRC stdd/_range/_package.d)
...
pure @safe nothrow unittest
{
    import stdd.internal.test.dummyrange : AllDummyRanges, propagatesRangeType,
        ReturnBy;
...
{//check the contract
    ...
    //stdd.exception.assertThrown won't do because it can't infer nothrow
    // @@@BUG@@@ 12647
    try
    {
...
{
    import stdd.algorithm.comparison : equal;
    import stdd.internal.test.dummyrange : AllDummyRanges, dummyLength,
                                          propagatesRangeType;
...
pure @safe nothrow unittest
{
    ...
    import stdd.exception : assumeWontThrow;
...
pure @safe nothrow unittest
{
    ...
    import stdd.exception : assumeWontThrow;
    import stdd.string : lineSplitter;
    assert("one\ntwo\nthree"
        .lineSplitter
        .tail(2)
        .joiner("\n")
...
{
    import stdd.algorithm.comparison : equal;
    import stdd.internal.test.dummyrange : AllDummyRanges, DummyRange, Length,
        RangeType, ReturnBy;
...
/++
    ...
    $(REF popFrontN, stdd, _range, primitives)`(range, n)` and returns `range`.
    ...
    $(REF popBackN, stdd, _range, primitives)`(range, n)`
    ...
    See_Also:
        $(REF popFront, stdd, _range, primitives), $(REF popBackN, stdd, _range, primitives)
  +/
...
{
    import stdd.algorithm.comparison : equal;
    import stdd.container.dlist : DList;
...
/++
    ...
    See_Also:
        $(REF popFrontExcatly, stdd, _range, primitives),
        $(REF popBackExcatly, stdd, _range, primitives)
+/
...
{
    import stdd.algorithm.comparison : equal;
    import stdd.algorithm.iteration : filterBidirectional;
...
pure @safe nothrow unittest //12007
{
    ...
    import stdd.algorithm.setops : cartesianProduct;
    import stdd.algorithm.comparison : equal;
...
pure @system unittest
{
    ...
    import stdd.exception : assertThrown, assertNotThrown;
    import stdd.typecons : tuple;
...
----
    import stdd.stdio : stdin, stdout;
...
$(REF sort, stdd,algorithm,sorting) which sorts $(D r) in place and returns the
...
{
    import stdd.algorithm.comparison : equal;
    import stdd.internal.test.dummyrange : AllDummyRanges, ReferenceInputRange;
    import stdd.meta : AliasSeq;
