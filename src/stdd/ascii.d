...
version(unittest)
{
    ...
    import stdd.traits; // : functionAttributes, FunctionAttribute, isSafe;
}
...
@safe unittest
{
    ...
    import stdd.digest.digest : toHexString;
...
@safe pure nothrow @nogc unittest
{
    ...
    assert(stdd.uni.isWhite('\u00A0'));
    assert(!isWhite('\u00A0')); // stdd.ascii.isWhite
}
