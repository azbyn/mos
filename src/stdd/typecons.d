...
/**
    Returns $(D true) if and only if $(D T) is an instance of $(D stdd.typecons.Tuple).
...
string generateLogger(C, alias fun)() @property
{
    ...
    stmt ~= q{ struct Importer { import stdd.stdio; } };
...
Generated code is inserted in the scope of $(D stdd.typecons) module.  Thus,
any useful functions outside $(D stdd.typecons) cannot be used in the generated
...
@system unittest
{
    import stdd.traits : FunctionAttribute, functionAttributes;
    interface A { int run(); }
...
{
    // Bugzilla 10377
    import stdd.range, stdd.algorithm;
...
@safe unittest
{
    import stdd.typecons : Typedef, TypedefType;
    import stdd.conv : to;
