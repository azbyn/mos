...
public:
    ...
    void addToken(TT type, QString&& msg);
...
public slots:
    ...
    // clang-format off
    void add_newLine()             { addToken(TT::newLine); }
    ...
    void add_identifier(QString s) { addToken(TT::identifier, s); }
    void add_number(QString s)     { addToken(TT::number, s); }
    void add_string(QString s)     { addToken(TT::string, s); }
