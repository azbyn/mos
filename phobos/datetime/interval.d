...
$(TR $(TD Flags) $(TD
    ...
    Source:    $(PHOBOSSRC stdd/datetime/_interval.d)
+/
module stdd.datetime.interval;

import core.time : Duration, dur;
import stdd.datetime.date : AllowDayOverflow, DateTimeException, daysToDayOfWeek,
                           DayOfWeek, isTimePoint, Month;
import stdd.exception : enforce;
import stdd.traits : isIntegral, Unqual;
...
public:
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if $(D_PARAM end) is
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if this interval is
            empty.
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if either interval is
            empty.
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the two intervals do
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) this interval is empty
    ...
    /++
        ...
        $(REF DateTimeException,stdd,datetime,date) will be thrown. The range
...
--------------------
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given interval
            is empty.
...
--------------------
    ...
    /++
        ...
        If $(D_PARAM func) ever generates a time point less than or equal to the
        current $(D front) of the range, then a
        $(REF DateTimeException,stdd,datetime,date) will be thrown.
...
--------------------
               ...
               __traits(compiles, end.add!"years"(1)))
    {
        /++
            ...
            Throws:
                $(REF DateTimeException,stdd,datetime,date) if empty is true or
...
@system unittest
{
    import stdd.datetime.date : Date, DayOfWeek;
...
{
    import stdd.datetime.date : enforceValid, monthsToMonth;
...
@system unittest
{
    import stdd.datetime.date : Date, Month;
...
{
    import core.time : dur;
    import stdd.datetime.date : AllowDayOverflow, Date;
...
/++
    ...
    $(D fwdRange) where that function took a $(REF Date,stdd,datetime,date) and
    returned a $(REF Date,stdd,datetime,date) which was one day later. That
    function would then be used by $(D IntervalRange)'s $(D popFront) to iterate
    over the $(REF Date,stdd,datetime,date)s in the interval.
    ...
    $(REF DateTimeException,stdd,datetime,date) will be thrown. So, to iterate
    ...
    then a $(REF DateTimeException,stdd,datetime,date) will be thrown. To
...
public:
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the range is empty.
      +/
...
private:
    ...
    /+
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if $(D_PARAM newTP) is
...
/++
    ...
    $(REF Date,stdd,datetime,date) and returned a $(REF Date,stdd,datetime,date)
    which was one day later. That function would then be used by
    $(D PosInfIntervalRange)'s $(D popFront) to iterate over the
    $(REF Date,stdd,datetime,date)s in the interval - though obviously, since the
    range is infinite, use a function such as $(D stdd.range.take) with it rather
    ...
    $(REF DateTimeException,stdd,datetime,date) will be thrown. So, the time
...
public:
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the generated time
...
/++
    ...
    $(D bwdRange) where that function took a $(REF Date,stdd,datetime,date) and
    returned a $(REF Date,stdd,datetime,date) which was one day earlier. That
    function would then be used by $(D NegInfIntervalRange)'s $(D popFront) to
    iterate over the $(REF Date,stdd,datetime,date)s in the interval - though
    obviously, since the range is infinite, use a function such as
    $(D stdd.range.take) with it rather than iterating over $(I all) of the dates.
