...
/++
    Exception type used by stdd.datetime. It's an alias to
...
/++
    Combines the $(REF Date,stdd,datetime,date) and
    $(REF TimeOfDay,stdd,datetime,date) structs to give an object which holds
    ...
    $(REF SysTime,stdd,datetime,systime). $(REF SysTime,stdd,datetime,systime) has
...
public:
    ...
    /++
        ...
        Params:
            tod = The $(REF TimeOfDay,stdd,datetime,date) to set this
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given hour would
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given minute
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given seconds
            would result in an invalid $(LREF DateTime).
     +/
...
public:
    ...
    /++
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the resulting
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given day is an
    ...
    /++
        ...
        Params:
            writer = A `char` accepting $(REF_ALTTEXT output range, isOutputRange, stdd, range, primitives)
        Returns:
            A `string` when not using an output range; `void` otherwise.
      +/
    string toISOString() const @safe pure nothrow
        ...
        if (isSomeString!S)
    {
        ...
        import stdd.conv : to, text, ConvException;
        import stdd.exception : enforce;
        import stdd.string : strip;
    ...
    {
        import stdd.algorithm.searching : startsWith;
        import stdd.conv : to, ConvException;
        import stdd.format : format;
        import stdd.string : strip;
...
public:
    ...
    /++
        ...
        Throws:
            $(REF DateTimeException,stdd,datetime,date) if the given second
            would result in an invalid $(LREF TimeOfDay).
     +/
    @property void second(int second) @safe pure
    {
    ...
    static TimeOfDay fromISOExtString(S)(in S isoExtString) @safe pure
        if (isSomeString!S)
    {
        import stdd.conv : ConvException, text, to;
        import stdd.string : strip;
...
{
    import core.time : Duration;
    import stdd.traits : FunctionAttribute, functionAttributes, Unqual;
...
{
    import core.time : Duration;
    import stdd.datetime.interval : Interval;
    import stdd.datetime.systime : SysTime;
...
{
    import core.time;
    import stdd.datetime.interval;
    import stdd.datetime.systime;
    import stdd.meta : AliasSeq;
...
/++
    ...
    $(D "nsecs") is not considered a valid unit of time. Nothing in stdd.datetime
...
/+
    ...
    Throws:
        $(REF DateTimeException,stdd,datetime,date) if the given month is not a
        valid month string.
  +/
