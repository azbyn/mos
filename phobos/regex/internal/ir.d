/*
    Implementation of stdd.regex IR, an intermediate representation
...
*/
module stdd.regex.internal.ir;

package(stdd.regex):

import stdd.exception, stdd.meta, stdd.range.primitives, stdd.traits, stdd.uni;

debug(std_regex_parser) import stdd.stdio;
...
package(stdd.regex):
    import stdd.regex.internal.kickstart : Kickstart; //TODO: get rid of this dependency
...
struct BackLooperImpl(Input)
{
    ...
    //support for backtracker engine, might not be present
    //void reset(size_t index){   _index = index ? index-stdd.utf.strideBack(_origin, index) : 0;  }
    void reset(size_t index){   _index = index;  }
