...
if (isForwardRange!R && is(ElementType!R : dchar))
{
    ...
    {
        uint r = 0;
        while (stdd.ascii.isDigit(front))
        {
            if (r >= (uint.max/10))
                ...
                if (front == '?')
                {
                    ...
                    case 'P':
                        ...
                        while (!empty && (isAlpha(front) ||
                            front == '_' || stdd.ascii.isDigit(front)))
                        {
                            name ~= front;
                            popFront();
                        }
    ...
    {//copy is @system
        ...
        case '{':
            ...
            enforce(stdd.ascii.isDigit(front), "First number required in repetition");
            min = parseDecimal();
            if (front == '}')
                max = min;
            else if (front == ',')
    ...
    {//accesses array of appender
        ...
        case '1': .. case '9':
            ...
            popFront();
            while (nref < maxBackref && !empty && stdd.ascii.isDigit(front))
            {
