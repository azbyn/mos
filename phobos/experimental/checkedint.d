...
void main()
{
    import stdd.experimental.checkedint, stdd.stdio;
...
$(BOOKTABLE ,
    $(TR $(TD $(LREF Abort)) $(TD
        ...
        stderr, stdd, stdio) followed by a call to `assert(0)`. It is the default
    ...
    $(TR $(TD $(LREF Warn)) $(TD
        prints incorrect operations to $(REF stderr, stdd, stdio)
...
Source: $(PHOBOSSRC stdd/experimental/_checkedint.d)
*/
module stdd.experimental.checkedint;
import stdd.traits : isFloatingPoint, isIntegral, isNumeric, isUnsigned, Unqual;
...
if (isIntegral!T || is(T == Checked!(U, H), U, H))
{
    ...
    import stdd.experimental.allocator.common : stateSize;
