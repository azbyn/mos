...
/**
Source: $(PHOBOSSRC stdd/experimental/logger/_filelogger.d)
*/
module stdd.experimental.logger.filelogger;

import stdd.experimental.logger.core;
import stdd.stdio;
...
class FileLogger : Logger
{
    ...
    */
    ...
    {
        import stdd.file : exists, mkdirRecurse;
        import stdd.path : dirName;
...
@safe unittest
{
    import stdd.file : rmdirRecurse, exists, deleteme;
    import stdd.path : dirName;
