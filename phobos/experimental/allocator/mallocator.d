...
Source: $(PHOBOSSRC stdd/experimental/allocator/_mallocator.d)
*/
module stdd.experimental.allocator.mallocator;
...
@nogc @system nothrow unittest
{
    static void test(A)()
    {
        import stdd.experimental.allocator : make;
        Object p = null;
...
version (Windows)
{
    ...
    version(CRuntime_DigitalMars)
    {
        ...
        {
            import stdd.c.stdlib : free;
            import stdd.c.string : memcpy;
