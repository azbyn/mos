...
Source: $(PHOBOSSRC stdd/experimental/allocator/_typed.d)

Macros:
T2=$(TR <td style="text-align:left">$(D $1)</td> $(TD $(ARGS $+)))
*/

module stdd.experimental.allocator.typed;

import stdd.experimental.allocator;
import stdd.experimental.allocator.common;
import stdd.range : isInputRange, isForwardRange, walkLength, save, empty,
    front, popFront;
import stdd.traits : isPointer, hasElaborateDestructor;
...
@system unittest
{
    ...
    import stdd.experimental.allocator.mmap_allocator : MmapAllocator;
