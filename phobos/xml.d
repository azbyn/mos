...
void main()
{
    string s = cast(string) stdd.file.read("books.xml");
 ...
 * the stdd.xml classes, because then all the encoding and decoding will be done
...
class Element : Item
{
    ...
    const
    {
        ...
        override string[] pretty(uint indent=2) scope
        {
            ...
            import stdd.string : rightJustify;
...
private
{
    ...
    {
        // TO DO - Fix stdd.utf stride and decode functions, then use those
        // instead
        import stdd.format : format;
...
class CheckException : XMLException
{
    ...
    {
        import stdd.string : count, lastIndexOf;
