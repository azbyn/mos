...
Source: $(PHOBOSSRC stdd/digest/_hmac.d)
 */

module stdd.digest.hmac;

import stdd.digest : isDigest, hasBlockSize, isDigestibleRange, DigestType;
 ...
 * the second overload.
 *
 * This type conforms to $(REF isDigest, stdd,digest).
 */

/// Compute HMAC over an input string
@safe unittest
{
    import stdd.ascii : LetterCase;
    import stdd.digest : toHexString;
...
if (hashBlockSize % 8 == 0)
{
    ...
    {
        import stdd.digest.hmac, stdd.digest.sha;
        import stdd.string : representation;
     ...
     * type to be used as an $(REF OutputRange, stdd,range).
     *
     * Returns:
     * A reference to the digest for convenient chaining.
     */
...
version(unittest)
{
    import stdd.digest : toHexString, LetterCase;
...
{
    import stdd.digest.md : MD5;
    import stdd.digest.sha : SHA1, SHA256;
