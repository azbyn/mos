...
This module is a submodule of $(MREF stdd, container).

Source: $(PHOBOSSRC stdd/container/_rbtree.d)
...
*/
module stdd.container.rbtree;

///
@safe pure unittest
{
    import stdd.algorithm.comparison : equal;
    import stdd.container.rbtree;
...
public import stdd.container.util;
 ...
 * that can be used by $(REF binaryFun, stdd,functional), or pass in a
...
if (is(typeof(binaryFun!less(T.init, T.init))))
{
    ...
    import stdd.range.primitives : isInputRange, walkLength;
    import stdd.traits : isIntegral, isDynamicArray, isImplicitlyConvertible;
...
--------------------
    ...
    debug(RBDoChecks)
    {
        ...
        {
            import stdd.stdio : write, writeln;
            if (n !is null)
            {
    ...
    /**
      ...
      stdd.format.formatValue). Note that this only is available when the
...
import stdd.range.primitives : isInputRange, ElementType;
import stdd.traits : isArray, isSomeString;
