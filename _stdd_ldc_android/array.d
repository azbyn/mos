...
static import stdd.algorithm.iteration; // FIXME, remove with alias of splitter
...
See_Also: $(REF Tuple, stdd,typecons)
 */
...
returns a new array. For a lazy version, refer to $(REF repeat, stdd,range).
 */
...
See_Also:
$(REF splitter, stdd,algorithm,iteration) for a version that splits using any
separator.
...
// @@@DEPRECATED_2017-01@@@
/++
    $(RED Deprecated. Use $(REF _splitter, stdd,algorithm,iteration) instead.
          This will be removed in January 2017.)

    Alias for $(REF _splitter, stdd,algorithm,iteration).
 +/
deprecated("Please use stdd.algorithm.iteration.splitter instead.")
alias splitter = stdd.algorithm.iteration.splitter;
...
/++
    ...
    See_Also:
        $(REF splitter, stdd,algorithm,iteration) for the lazy version of this
        function.
 +/
