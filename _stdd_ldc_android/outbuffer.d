 ...
 * Source:    $(PHOBOSSRC stdd/_outbuffer.d)
 */
module stdd.outbuffer;
...
class OutBuffer
{
  ...
  pure nothrow @safe
  {
    ...
    void vprintf(string format, va_list args) @trusted nothrow
    {
        ...
        // "cannot mix core.stdd.stdlib.alloca() and exception handling".
     ...
     *
     * Params:
     *  fmt = format string as described in $(REF formattedWrite, stdd,format)
     *  args = arguments to be formatted
     *
     * See_Also:
     *  $(REF _writef, stdd,stdio);
     *  $(REF formattedWrite, stdd,format);
     */
