...
import stdd.typetuple; // TypeTuple
...
@safe unittest
{
    import stdd.traits : functionAttributes, FunctionAttribute;
...
Note:
 ...
 you should use the $(REF NoDuplicates, stdd,typetuple) template to avoid
...
--------------------
module test;
import stdd.traits : mangledName;
...
template getSymbolsByUDA(alias symbol, alias attribute) {
    import stdd.format : format;
    import stdd.meta : AliasSeq, Filter;
