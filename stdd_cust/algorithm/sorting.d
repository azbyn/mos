...
$(T2 completeSort,
        ...
        combination $(D $(REF chain, stdd,range)(a, b)) is sorted.)
$(T2 isPartitioned,
...
$(D sort) returns a $(REF SortedRange, stdd,range) over the original range,
...
unittest
{
    ...
    import stdd.random, stdd.algorithm.iteration, stdd.algorithm.mutation;
    Random rng;
