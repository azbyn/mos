...
*/
module stdd.internal.math.biguintcore;

version(D_InlineAsm_X86)
{
    import stdd.internal.math.biguintx86;
}
else version(LDC)
{
    version(ARM_Thumb)
        import stdd.internal.math.biguintnoasm;
    else version(ARM)
        import stdd.internal.math.biguintarm;
    else
        import stdd.internal.math.biguintnoasm;
}
else
...
private import stdd.exception : assumeUnique;
private import stdd.traits : isIntegral;
...
private:
  ...
  package(stdd)  // used from: stdd.bigint
