/**
    ...
    Source:    $(PHOBOSSRC stdd/windows/_registry.d)
*/
/* /////////////////////////////////////////////////////////////////////////////
 *
...
import stdd.conv;
import stdd.utf : toUTF8, toUTF16;
private import stdd.internal.windows.advapi32;
import stdd.internal.cstring;

//debug = winreg;
debug(winreg) import stdd.stdio;
...
version(unittest) import stdd.string : startsWith, endsWith;
...
/**
    Exception class thrown by the stdd.windows.registry classes.
 */
...
body
{
    ...
    auto list = stdd.array.split(data[], "\0");
...
public:
    ...
    void setValue(string name, string[] value)
    {
        ...
        data[$-1] = "\0";
        auto ws = stdd.array.join(data, "\0"w);
...
unittest
{
    ...
    debug(winreg) writefln("stdd.windows.registry.unittest read");
...
{
    debug(winreg) scope(success) writeln("unittest @", __FILE__, ":", __LINE__, " succeeded.");
    debug(winreg) writefln("stdd.windows.registry.unittest write");
