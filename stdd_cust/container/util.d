...
Source: $(PHOBOSSRC stdd/container/_util.d)
...
if (is(T == struct) || is(T == class))
{
    ...
    {
        // constructing an stdd.container.Array without arguments,
...
template make(alias Container, Args...)
    if (!is(Container))
{
    import stdd.range : isInputRange, isInfinite;
...
unittest
{
    ...
    import stdd.range : only, repeat;
    import stdd.range.primitives : isInfinite;
...
unittest
{
    import stdd.container.array, stdd.container.rbtree, stdd.container.slist;
