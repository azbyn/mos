...
Source: $(PHOBOSSRC stdd/container/_binaryheap.d)
...
*/
module stdd.container.binaryheap;
...
if (isRandomAccessRange!(Store) || isRandomAccessRange!(typeof(Store.init[])))
{
    ...
    import stdd.algorithm.mutation : move, swapAt;
    import stdd.algorithm.sorting : HeapOps;
...
// stdd.algorithm can't unittest anymore
//private:
    ...
    // @@@BUG@@@: add private here, stdd.algorithm doesn't unittest anymore
...
unittest // 15675
{
    import stdd.container.array : Array;
