...
Source: $(PHOBOSSRC stdd/container/_slist.d)
...
unittest
{
    ...
    import stdd.range : popFrontN, walkLength;
...
struct SList(T)
{
    ...
    import stdd.range.primitives : isInputRange, isForwardRange, ElementType;
...
assert(stdd.algorithm.equal(sl[], ["a", "b", "d", "e"]));
sl.insertAfter(stdd.range.take(sl[], 2), "c"); // insert after "b"
assert(stdd.algorithm.equal(sl[], ["a", "b", "c", "d", "e"]));
--------------------
     */
