...
import stdd.digest.crc, stdd.file, stdd.stdio, stdd.zip;
...
final class ArchiveMember
{
    ...
    import stdd.datetime : DosFileTime, SysTime, SysTimeToDosFileTime;
     ...
     * $(REF getAttributes, stdd,file) or $(REF DirEntry.attributes, stdd,file), for this archive member.
     */
...
{
    import stdd.bitmanip : littleEndianToNative, nativeToLittleEndian;
    import stdd.algorithm.comparison : max;
    import stdd.conv : to;
    import stdd.datetime : DosFileTime;
...
@system unittest
{
    ...
    import stdd.random : uniform, MinstdRand0;
    import stdd.stdio, stdd.conv;
    MinstdRand0 gen;
...
@system unittest
{
    import stdd.random : Mt19937, randomShuffle;
    import stdd.conv : to;
...
{
    import stdd.datetime, stdd.file, stdd.format, stdd.path, stdd.process, stdd.stdio;
    ...
    stdd.file.write(zipFile, cast(byte[])data2);
