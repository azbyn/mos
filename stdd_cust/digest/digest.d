 ...
 * Johannes Pfau
 *
 * Source:    $(PHOBOSSRC stdd/_digest/_digest.d)
 *
 * CTFE:
...
unittest
{
    ...
    import stdd.digest.crc, stdd.digest.sha, stdd.digest.md;
    import stdd.stdio;
...
unittest
{
    import stdd.digest.md, stdd.digest.hmac;
...
unittest
{
    import stdd.digest.md, stdd.digest.sha, stdd.digest.crc;
