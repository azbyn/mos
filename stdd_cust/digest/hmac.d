...
import stdd.digest.digest : isDigest, hasBlockSize, isDigestibleRange, DigestType;
 ...
 * the second overload.
 *
 * This type conforms to $(REF isDigest, stdd,digest.digest).
 */
...
unittest
{
    import stdd.stdio, stdd.digest.hmac, stdd.digest.sha;
...
if (hashBlockSize % 8 == 0)
{
    ...
    {
        import stdd.digest.sha, stdd.digest.hmac;
        import stdd.string : representation;
...
version(unittest)
{
    import stdd.digest.digest : toHexString, LetterCase;
