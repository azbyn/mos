 ...
 * )
 *
 * Source: $(PHOBOSSRC stdd/digest/_sha.d)
 *
 */
 ...
 */
module stdd.digest.sha;

///
unittest
{
    //Template API
    import stdd.digest.sha;
 ...
 * Can be removed if the optimizer can inline the methods from stdd.bitmanip.
 */
...
struct SHA(uint hashBlockSize, uint digestSize)
{
    ...
    static if (digestSize==160) /* SHA-1 */
    {
        version(USE_SSSE3)
        {
            ...
            import stdd.internal.digest.sha_SSSE3 : sse3_constants=constants, transformSSSE3;
...
/**
 * These are convenience aliases for $(REF digest, stdd,digest,digest) using the
 * SHA implementation.
 */
 ...
 * See $(D stdd.digest.digest) for differences between template and OOP API.
 *
 * This is an alias for $(D $(REF WrapperDigest, stdd,digest,digest)!SHA1), see
