 ...
 * )
 *
 * Source: $(PHOBOSSRC stdd/digest/_ripemd.d)
 *
 */

module stdd.digest.ripemd;
...
struct RIPEMD160
{
    private:
            ...
            pure nothrow @nogc
        {
            ...
            version(BigEndian)
            {
                import stdd.bitmanip : littleEndianToNative;
 ...
 * See $(D stdd.digest.digest) for differences between template and OOP API.
 *
 * This is an alias for $(D $(REF WrapperDigest, stdd,digest,digest)!RIPEMD160),
