 ...
 *
 * This module conforms to the APIs defined in $(D stdd.digest.digest). To understand the
 * differences between the template and the OOP API, see $(D stdd.digest.digest).
 *
 * This module publicly imports $(D stdd.digest.digest) and can be used as a stand-alone
 * module.
 *
 * Note:
 * CRCs are usually printed with the MSB first. When using
 * $(REF toHexString, stdd,digest,digest) the result will be in an unexpected
 * order. Use $(REF toHexString, stdd,digest,digest)'s optional order parameter
...
/**
 * This is a convenience alias for $(REF toHexString, stdd,digest,digest)
 ...
 * See $(D stdd.digest.digest) for differences between template and OOP API.
 *
 * This is an alias for $(D $(REF WrapperDigest, stdd,digest,digest)!CRC32), see
