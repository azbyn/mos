...
@safe pure unittest
{
    assert(testAliasedString!indexOf("stdd/string.d", '/', 3));
}
...
/++
    Strips leading whitespace (as defined by $(REF isWhite, stdd,uni)).
...
/++
    Strips trailing whitespace (as defined by $(REF isWhite, stdd,uni)).
...
@safe pure @nogc unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.inPattern.unittest\n");
...
@safe pure @nogc unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.count.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.removechars.unittest\n");
...
@system pure unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.squeeze.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.succ.unittest\n");
...
@safe pure unittest
{
    ...
    debug(string) trustedPrintf("stdd.string.tr.unittest\n");
