...
$(MREF stdd, algorithm) or $(MREF stdd, range).
...
template unaryFun(alias fun, string parmName = "a")
{
    static if (is(typeof(fun) : string))
    {
        ...
        {
            import stdd.traits, stdd.typecons, stdd.meta;
            import stdd.algorithm, stdd.conv, stdd.exception, stdd.math, stdd.range, stdd.string;
        }
...
@safe unittest
{
    import stdd.functional, stdd.typecons : Tuple;
