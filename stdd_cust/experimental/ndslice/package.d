...
2. `stdd.format`, `stdd.string`, and `stdd.conv` should not be used in error
...
{
    import stdd.algorithm.sorting : topN;
...
{
    import stdd.conv : to;
    import stdd.getopt : getopt, defaultGetoptPrinter;
    import stdd.path : stripExtension;
...
Source:    $(PHOBOSSRC stdd/_experimental/_ndslice/_package.d)

Macros:
SUBMODULE = $(MREF_ALTTEXT $1, stdd,experimental, ndslice, $1)
...
module stdd.experimental.ndslice;

public import stdd.experimental.ndslice.slice;
public import stdd.experimental.ndslice.iteration;
public import stdd.experimental.ndslice.selection;
...
pure nothrow unittest
{
    import stdd.experimental.ndslice.internal : Iota;
