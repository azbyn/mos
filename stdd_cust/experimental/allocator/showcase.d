...
*/
module stdd.experimental.allocator.showcase;

import stdd.experimental.allocator.building_blocks.fallback_allocator,
    stdd.experimental.allocator.gc_allocator,
    stdd.experimental.allocator.building_blocks.region;
...
auto mmapRegionList(size_t bytesPerRegion)
{
    static struct Factory
    {
        ...
        private import stdd.algorithm.comparison : max;
        private import stdd.experimental.allocator.building_blocks.region
            : Region;
        private import stdd.experimental.allocator.mmap_allocator
            : MmapAllocator;
        this(size_t n)
        {
            bytesPerRegion = n;
    ...
    import stdd.experimental.allocator.building_blocks.allocator_list
        : AllocatorList;
    import stdd.experimental.allocator.building_blocks.null_allocator
        : NullAllocator;
