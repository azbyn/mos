...
module stdd.internal.math.biguintarm;
...
static import stdnoasm = stdd.internal.math.biguintnoasm;
...
version(unittest)
{
    static import stdd.internal.math.biguintnoasm;
    ...
    void testMultibyteAddSub()
    {
        for (int j = 0; j < loopMax; j++)
        {
            ...
            auto c2 = stdd.internal.math.biguintnoasm.multibyteAddSub!('+')(r2[0..arraySz], a[0..arraySz], b[0..arraySz], carry);
            ...
            c2 = stdd.internal.math.biguintnoasm.multibyteAddSub!('-')(r2[0..arraySz], a[0..arraySz], b[0..arraySz], carry);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(c1 == c2);
            assert(c1 == 0 || c1 == 1);
            assert(a[arraySz] == tombstone);
    ...
    void testMultibyteIncrementAssign()
    {
            ...
            auto c2 = stdd.internal.math.biguintnoasm.multibyteIncrementAssign!('+')(b[0..arraySz], carry);
            ...
            c2 = stdd.internal.math.biguintnoasm.multibyteIncrementAssign!('-')(b[0..arraySz], carry);
            assert(a[0..arraySz] == b[0..arraySz]);
            assert(c1 == c2);
            assert(c1 == 0 || c1 == 1);
            assert(a[arraySz] == tombstone);
    ...
    void testMultibyteShl()
    {
        for (int i = 0; i < loopMax; i++)
        {
            ...
            auto sh2 = stdd.internal.math.biguintnoasm.multibyteShl(r2[0..arraySz], a[0..arraySz], shift);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(sh1 == sh2);
            assert(a[arraySz] == tombstone);
            assert(r1[arraySz] == tombstone);
    ...
    void testMultibyteShr()
    {
        for (int i = 0; i < loopMax; i++)
        {
            ...
            stdd.internal.math.biguintnoasm.multibyteShr(r2[0..arraySz], a[0..arraySz], shift);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(a[arraySz] == tombstone);
            assert(r1[arraySz] == tombstone);
            assert(r2[arraySz] == tombstone);
    ...
    void testMultibyteMul()
    {
        for (int i = 0; i < loopMax; i++)
        {
            ...
            auto c2 = stdd.internal.math.biguintnoasm.multibyteMul(r2[0..arraySz], a[0..arraySz], mult, carry);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(c1 == c2);
            assert(a[arraySz] == tombstone);
            assert(r1[arraySz] == tombstone);
    ...
    void testMultibyteMulAdd()
    {
        for (int i = 0; i < loopMax; i++)
        {
            ...
            auto c2 = stdd.internal.math.biguintnoasm.multibyteMulAdd!('+')(r2[0..arraySz], a[0..arraySz], mult, carry);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(c1 == c2);
            assert(a[arraySz] == tombstone);
            assert(r1[arraySz] == tombstone);
            ...
            c2 = stdd.internal.math.biguintnoasm.multibyteMulAdd!('-')(r2[0..arraySz], a[0..arraySz], mult, carry);
            assert(r1[0..arraySz] == r2[0..arraySz]);
            assert(c1 == c2);
            assert(a[arraySz] == tombstone);
            assert(r1[arraySz] == tombstone);
    ...
    void testMultibyteAddDiagonalSquares()
    {
        for (int i = 0; i < loopMax; i++)
        {
            ...
            stdd.internal.math.biguintnoasm.multibyteAddDiagonalSquares(r2, a[0..arraySz]);
...
version(timings)
{
    ...
    void main()
    {
        ...
        for (size_t i = 0; i < dataSz; i +=2)
        {
            auto c1 = stdd.internal.math.biguintnoasm.multibyteAddSub!('+')(r, data[i], data[i+1], 0);
        }
        // Time
        sw.start();
        for (size_t j = 0; j < loopCount; j++)
        ...
        for (size_t i = 0; i < dataSz; i +=2)
        {
            auto c1 = stdd.internal.math.biguintnoasm.multibyteMul(r, data[i], 17, 0);
        }
        // Time
        sw.start();
        for (size_t j = 0; j < loopCount; j++)
        ...
        for (size_t i = 0; i < dataSz; i +=2)
        {
            auto c1 = stdd.internal.math.biguintnoasm.multibyteMulAdd!('+')(r, data[i], 17, 0);
        }
        // Time
        sw.start();
        for (size_t j = 0; j < loopCount; j++)
